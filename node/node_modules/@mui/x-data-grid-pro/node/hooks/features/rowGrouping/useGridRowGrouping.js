...
const useGridRowGrouping = (apiRef, props) => {
  ...
  (0, _xDataGrid.useGridApiEventHandler)(apiRef, 'columnsChange', checkGroupingColumnsModelDiff);
  (0, _xDataGrid.useGridApiEventHandler)(apiRef, 'rowGroupingModelChange', checkGroupingColumnsModelDiff);
  /**
   * EFFECTS
   */
