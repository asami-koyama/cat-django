...
const CatCreate = () => {
    ...
    const [values, setValues] = useState({
        ...
        location:       {value: '', headerName: '地方', isEmpty: false, errorText:''},
        protected_date: {value: today , headerName: '保護日', isEmpty: false, errorText:''},
        age_year:       {value: 0, headerName: '年齢', isEmpty: false, errorText:''},
        age_month:      {value: 0, headerName: '年齢', isEmpty: false, errorText:''},
        gender:         {value: choiceGender[0].label, headerName: '性別', isEmpty: false, errorText:''},
    ...
    const changeRequired = (e) => {
        ...
        setValues({...values, [targetName]: { ...values[targetName], value: data ,isEmpty: dataIsEmpty } });
    ...
    function changeNoRequired(e) {
        ...
        const data = target.value;
        const targetName = target.name;
        setValues({...values, [targetName]: { ...values[targetName], value: data } });
    }
    ...
    function changeImage(e){
        ...
        reader.onloadend = () => {
            setValues({...values, image: { ...values.image, value: file ,previewImage: reader.result} });
        }
    ...
    Object.keys(values).forEach(function (key) {
        ...
        if (value.isEmpty){
            value.errorText = (<Typography variant="body2" sx={{color:'#FF0000'}}>
    ...
    const registerData = () =>{
        ...
        axios.post(`http://192.168.150.201:8000/api/cats/`, form_data,{headers: {
    ...
    return (
        <ThemeProvider theme={Sign}>
            ...
            <Container component="main" maxWidth="sm" alignitems="center" justify="center" sx={{backgroundColor: '#FFFFFF', minHeight: '100vh'}}>
                    ...
                    <Grid container spacing={2}>        
                        <Grid item xs={12}>
                            <label htmlFor="contained-button-file">
                                ...
                                <Button aria-label="upload picture" component="span" color="secondary">
                                    画像をアップロード<PhotoCamera />
                                </Button>
                            </label> 
                        </Grid>
                        <Grid item xs={12}>
                            <img src={values.image.previewImage} style={{width:"60%" }}/>
                        </Grid>
                        <Grid item xs={12}>
                            <TextField
                                name="name"
